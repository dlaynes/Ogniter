...
@section('title')Ogniter - Evolution: All universes @stop
@section('description')Players & planets evolution in all countries  @stop
...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li>
            <a href="{{ $currentCountry->language }}/country-evolution">Evolution</a>
        </li>
    </ul>
    @endsection
